...
The [**Horusec-Dart**]({{< ref path="/cli/analysis-tools/open-source-horusec-engine/horusec-dart.md" lang="en">}}) it is a SASAS tool created by Horusec team to search for vulnerabilities in Dart projects.

## Rules

{{% alert color="info" %}}
Next, you find all the rules for Horusec-Dart.The content was held in English because this is how the message appears in the system.
{{% /alert %}}
