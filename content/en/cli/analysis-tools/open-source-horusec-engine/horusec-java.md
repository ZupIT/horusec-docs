...
The [**Horusec-Java**](/docs/cli/analysis-tools/open-source-horusec-engine/horusec-java/#horusec-java-cli) is a SAST tool created by the Horusec team in order to search vulnerabilities on java projects. 
