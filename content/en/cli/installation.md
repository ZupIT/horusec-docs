...
* [**Docker**](https://docs.docker.com/get-docker/)
  - {{% alert color="warning" %}}
For disable docker, you can see [how to use Horusec without Docker tutorial]({{< ref path="/tutorials/how-to-use-horusec-without-docker.md" lang="en" >}}), but you will lose your analysis with [other tools]({{< ref path="/cli/analysis-tools/security-tools.md" lang="en" >}}).
    {{% /alert %}}
