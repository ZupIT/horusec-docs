...
weight: 1
description: >-
  In this section, you will find CLI commands flags.
---
...
<table>
  ...
  <tbody>
    <tr>
    <td style="text-align:left">start, generate and version</td>
...
{{% alert color="warning" %}}
You can only use these flags with the **`start`** command.
{{% /alert %}}
