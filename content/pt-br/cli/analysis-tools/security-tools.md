...
O [**Bundler**](https://github.com/rubysec/bundler-audit) é uma ferramenta de segurança para auditoria de dependencias de Ruby a fim de garantir que os aplicativos executem o mesmo código em todas as máquinas.
