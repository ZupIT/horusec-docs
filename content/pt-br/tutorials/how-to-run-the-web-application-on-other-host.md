...
Alguns serviços não são iniciados por padrão, como por exemplo [**Horusec-Messages**](/docs/pt-br/web/services/messages) e o [**Horusec-Webhook**]({{< ref path="/web/services/webhook.md" lang="pt-br">}}). 

Após instalar você pode perceber que alguns serviços por padrão **não são iniciados**. Isto acontece porque esses serviços, como o de mensageria, já vem configurado para estar desabilitado, caso você necessite realizar o uso destes serviços basta [**seguir o tutorial de como habilitar e desabilitar o serviço de mensageria**]({{< ref path="/tutorials/how-to-enable-disable-messaging-service.md" lang="pt-br">}}).
