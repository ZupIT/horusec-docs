...
{{% alert color="info" %}}
Como a Nativa Horusec já é a autenticação default de instalação, se você deseja trocar para os outros tipos, veja o [**tutorial de
como alterar**](/docs/pt-br/tutorials/how-to-change-the-authentication-type/). 
{{% /alert %}}
