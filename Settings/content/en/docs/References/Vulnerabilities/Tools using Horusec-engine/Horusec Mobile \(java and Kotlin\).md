...
# Horusec Mobile \(Java and Kotlin\)

## What is it?

The  [**Horusec-Kotlin**](https://github.com/ZupIT/horusec/tree/master/horusec-kotlin#horusec-kotlin-cli)  and the **Horusec-Java** are SAST tools created by the Horusec team to search vulnerabilities on projects programmed with Kotlin or Java.

## Examples of vulnerabilities 

{{% alert color="info" %}}
Next, you find all the vulnerabilities examples identified by Horusec-Kotlin and Horusec-Java. The content is shown as it appears in the system.
{{% /alert %}}

### Horusec-Kotlin \(Mobile\) \| Horusec-Java \(Mobile\)

The tools [**Horusec-Kotlin**](https://github.com/ZupIT/horusec/tree/master/horusec-kotlin#horusec-kotlin-cli) e  [**Horusec-Java**](https://github.com/ZupIT/horusec/tree/master/horusec-java#horusec-java-cli)**, besides** applying  specific rules to your languages, also identifies some generic rules for mobile applications that use Android or iOS in these respective languages.
